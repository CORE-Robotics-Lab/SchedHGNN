...
def get_config():
    ...
    Prepare parameters:
        --algorithm_name <algorithm_name>
            specifically the algorithm, including `["rmappo", "hetgat_mappo"]`
        --experiment_name <str>
            an identifier to distinguish different experiment.
        --seed <int>  # todo: ----------> important hyper-param
            set seed for numpy and torch 
        --cuda
            by default True, will use GPU to train; or else will use CPU; 
        --cuda_deterministic
            by default, make sure random seed effective. if set, bypass such function.
        --n_training_threads <int>  # todo: ----------> important hyper-param
            number of training threads working in parallel. by default 1
        --n_rollout_threads <int>  # todo: ----------> important hyper-param
            number of parallel envs for training rollout. by default 32
        --n_eval_rollout_threads <int>  # todo: ----------> important hyper-param
            number of parallel envs for evaluating rollout. by default 1
        --n_render_rollout_threads <int>
            number of parallel envs for rendering, could only be set as 1 for some environments.
        --num_env_steps <int>  # todo: ----------> important hyper-param
    ...
    Replay Buffer parameters:
        --episode_length <int>  # todo: ----------> important hyper-param
    ...
    Optimizer parameters:
        --lr <float>  # todo: ----------> important hyper-param
            learning rate parameter,  (default: 5e-4, fixed).
        --critic_lr <float>  # todo: ----------> important hyper-param
            learning rate of critic  (default: 5e-4, fixed)
        --opti_eps <float>  # todo: ----------> important hyper-param
            RMSprop optimizer epsilon (default: 1e-5)
        --weight_decay <float>  # todo: ----------> important hyper-param
            coefficience of weight decay (default: 0)
    
    PPO parameters:
        --ppo_epoch <int>  # todo: ----------> important hyper-param
            number of ppo epochs (default: 15)
        --use_clipped_value_loss 
            by default, clip loss value. If set, do not clip loss value.
        --clip_param <float>
            ppo clip parameter (default: 0.2)
        --num_mini_batch <int>  # todo: ----------> important hyper-param
            number of batches for ppo (default: 1)
        --entropy_coef <float>  # todo: ----------> important hyper-param
            entropy term coefficient (default: 0.01)
        --use_max_grad_norm  # todo: ----------> important hyper-param
    ...
    Eval parameters:
        --use_eval  # todo: ----------> important hyper-param
            by default, do not start evaluation. If set`, start evaluation alongside with training.
        --eval_interval <int>  # todo: ----------> important hyper-param
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='rmappo', choices=["rmappo", "hetgat_mappo"])
    ...
    parser.add_argument("--use_value_func_during_execution", action='store_true',
                        default=False, help="Use value function during execution to approximate termination prob")
    ...
    parser.add_argument("--comm_depth", default=2, type=int, help="communication depth, i.e. # of communication layers")
    parser.add_argument("--binarized_obs_comm", action='store_true', default=False, help='get binarized obs & communicate it directly, only supported on hetgat_mappo & Marine, make sure tensor_obs=False when binarized_obs_comm=True')
    ...
    parser.add_argument("--use_LSTM", action='store_true',
                        default=False, help="use LSTM instead of GRU, this not supported")
