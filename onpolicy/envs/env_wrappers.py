...
class ShareDummyVecEnv(ShareVecEnv):
    ...
    def get_info(self):
        return self.envs[0].get_info()

    def update_epoch(self, epoch_rate):
        self.envs[0].curr_epoch_update(epoch_rate)

# class ShareDummyVecKDMagicEnv(ShareVecEnv):
class ShareDummyVecKDEnv(ShareVecEnv):
    def __init__(self, env_fns):
        self.envs = [fn() for fn in env_fns]
        env = self.envs[0]
        ShareVecEnv.__init__(self, len(
    ...
    # def get_magic_obs_done_info(self):
    #     return self.envs[0].get_magic_obs_done_info()
    def get_scheduling_obs(self):
        return self.envs[0]._get_scheduling_tensor_obs()
